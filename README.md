<h1 align=center style="color:aqua" >Hello :wave: its Esra over here!</h1>
<h2>I'm Software Test Specialist</h2>
<h3>About me :four_leaf_clover: </h3>
I took about a year of bootcamp training and experienced my manual, automation, API knowledge by doing an internship in a project.

I have experience in both Agile Scrum ,SDLC and STLC techniques for quality assurance and software automation

Developed Cucumber feature files using Gherkin, fostering a clear understanding involved in the project.

Proficiency with Selenium, Java, Maven, JUnit, TestNG and Cucumber BDD, Jmeter and Appium for automation testing.

A team member who has strong communication skills, is eager to learn, can think analytically
I believe myself to be a consistently upbeat individual that is productive, quick to self-learn, and quickly adaptable to new situations and technologies. I have good teamwork, awareness, and communication abilities.
